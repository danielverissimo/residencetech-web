...
return [
	...
	*/
	...
	'routes' => function(ExtensionInterface $extension, Application $app)
	{
		Route::group([
			'prefix'    => admin_uri(),
			'namespace' => 'Residencetech\Admin\Controllers\Admin',
		], function()
		{
			Route::get('/' , ['as' => 'admin.residencetech.admin', 'uses' => 'DashboardController@index']);
	...
	*/
	...
	{
		$permissions->group('admin', function($g)
		{
			$g->name = 'Admin Dashboard';

			$g->permission('admin.index', function($p)
			{
				$p->label = trans('residencetech/admin::admin/permissions.dashboard');

				$p->controller('Residencetech\Admin\Controllers\Admin\DashboardController', 'index');
			});
